...
(function() {
  ...
  run = function() {
    ...
    commander.version(require('../package.json').version).description('Decrypts NaCl crypto_box JSON from stdin to stdout using client keyfile.').usage('-k [client-keys.json]').option('-k, --keys [keyfile]', 'Client keyfile. Generate with salty-keygen.').parse(process.argv);
